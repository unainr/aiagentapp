      ...
      <div className=" w-full">
        ...
        <div className="bg-white rounded-2xl overflow-hidden border border-gray-200">
          <div className="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="pt-6 border-t border-gray-200">
                  <div className="grid grid-cols-1 gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 text-sm">Visual Builder</p>
                        <p className="text-xs text-gray-600">Drag and drop interface</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-gray-900 rounded-full mt-2"></div>
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Smart automation nodes</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-gray-900 rounded-full mt-2"></div>
            ...
            <div className="lg:col-span-3 relative bg-gray-50 min-h-[600px] h-[600px]">
              ...
              {/* Overlay Label */}
              <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm border border-gray-200 z-10">
                <p className="text-xs font-medium text-gray-700">Interactive Canvas Preview</p>
              </div>
            </div>
          </div>
        </div>
